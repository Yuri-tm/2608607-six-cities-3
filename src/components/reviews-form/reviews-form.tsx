...
export default function ReviewsForm(): JSX.Element {
  ...
  //Валидация формы — кнопка "Submit" активна только если выбран рейтинг и текст содержит минимум 50 символов
  const isFormValid = rating !== '' && review.length >= 50;
  ...
  return (
    <form className="reviews__form form" action="#" method="post">
      ...
      <textarea className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" value={review} onChange={handleReviewChange}></textarea>
